...
CREATE INDEX idx_scenarios_user ON training_scenarios(user_id);
CREATE INDEX idx_scenarios_difficulty ON training_scenarios(difficulty);
CREATE INDEX idx_scenarios_global ON training_scenarios(is_global);
...
CREATE INDEX idx_training_sessions_score ON training_sessions(overall_score);
